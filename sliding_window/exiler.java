...
public class exiler {
    public static int kthSmallestElixir(int n, int k, int m, int[] plants) {
        ...
        Collections.sort(potencies);
        return potencies.get(k - 1);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(kthSmallestElixir(n, k, m, plants));
        sc.close();
    }
}
